...
**Race in the Inbox: Peer Benchmarking Reduces Disparity in Agenda Access; Pressure Frame Backfires**. **with** Danyao Li; Yixin Liu; Huimin Zheng.
...
**Relieving Administrative Burdens for Nonprofit Service Providers in the Governmental Grantmaking Process: A Research-Practice Partnership**. **with** Yuan (Daniel) Cheng; Weston Merrick; Patrick Carter; Kari Aanestad.
...
**Understanding Diverse Knowledge Used in Civil Servants' Decision Making** (Finalizing). **with** Shuping Wang; Yuan-Daniel Cheng; Patrick Carter; Weston Merrick.
...
**GPT Models for Text Annotation: An Empirical Exploration in Public Policy Research** (2025. *Policy Studies Journal (Online first)*). **with** Alexander Churchill; Shamitha Pichika; Ying Liu.

<details>
<summary>Abstract</summary>

Text annotation, the practice of labeling text following a predetermined scheme, is essential to public policy research but often requires significant time and labor. Recent advances in generative pre-trained transformers (GPTs) show a potential approach that may alleviate these burdens. This study offers an empirical evaluation of GPT models for text annotation in public policy research, focusing on accuracy, reliability, and cost-effectiveness. Using a large hand-labeled dataset and multiple annotation tasks, we compare GPT-based annotations with human-coded benchmarks and assess how prompt design, model choice, and task complexity affect performance. We find that GPT models can achieve high accuracy for many common annotation tasks, though performance varies across labels and contexts. We discuss practical guidance for researchers on when and how to use GPT models for annotation, including recommended workflows and transparency practices.
...
**Understanding Diverse Knowledge Used in Civil Servants' Decision Making**. **with** Shuping Wang; Yuan-Daniel Cheng; Patrick Carter; Weston Merrick.
...
**For-Profit Fundraisers Make Nonprofits Market-Focused in Donors’ Eyes** (Revise and Resubmit at *Nonprofit and Voluntary Sector Quarterly*). **with** Kenneth Meier.
...
**How does Commercial Incomes Crowd-out Private Donations?** (Finalizing). **with** ChiaKo Hung; Huafang Li.
